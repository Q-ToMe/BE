...
public class QFriend extends EntityPathBase<Friend> {
    ...
    private static final long serialVersionUID = -1222709681L;
    ...
    public final com.example.qtome_be.member.QMember master;

    public final com.example.qtome_be.member.QMember slave;
    ...
    public QFriend(Class<? extends Friend> type, PathMetadata metadata, PathInits inits) {
        ...
        this.master = inits.isInitialized("master") ? new com.example.qtome_be.member.QMember(forProperty("master")) : null;
        this.slave = inits.isInitialized("slave") ? new com.example.qtome_be.member.QMember(forProperty("slave")) : null;
    }
